...
def endpage():
    ...
    c = Label(mf, text="Number of Right Answers : 7", bg="grey", fg="black", font=("Times New Roman", 20,))
    ...
    c = Label(mf, text="Number of Unattempted Answers : 1", bg="grey", fg="black", font=("Times New Roman", 20,))
    c.place(relx=0.1, rely=0.5)
    sc = Label(mf, text="YOUR TOTAL SCORE IS : 6.5/10", bg="grey", fg="black", font=("Times New Roman", 30, 'bold'))
...
#submit
S = Button(ef, text="SUBMIT", bg="black", fg="white", font=("Times New Roman", 20, "bold"), width=10, bd=3,activebackground="grey", activeforeground="black", highlightcolor="grey")
